...
class CompanyEmpWage {
	...
	public CompanyEmpWage(String companyName, int wagePerHour, int fullTimeHours, int partTimeHours, int maxWorkingDays,
			int maxWorkingHours) {
...
class EmpWageBuilder2 {
	...
	public EmpWageBuilder2() {
		companies = new CompanyEmpWage[MAX_COMPANIES];
		companyCount = 0;
		random = new Random();
	}
	...
	public void addCompany(String companyName, int wagePerHour, int fullTimeHours, int partTimeHours,
		...
		if (companyCount < MAX_COMPANIES) {
			companies[companyCount++] = new CompanyEmpWage(companyName, wagePerHour, fullTimeHours, partTimeHours,
