...
public class StudentGrouping {
	public static void main(String[] args) {
		List<Student> students = Arrays.asList(new Student("Govind", "A"), new Student("Akash", "B"),
				new Student("Aman", "A"), new Student("Nitai", "B"));

		Map<String, List<String>> groupedByGrade = students.stream().collect(
